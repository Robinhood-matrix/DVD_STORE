...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-5 form" style="height:411px; top: -91px; left: 0px;">
                    ...
                    <div class="form-group">
                     ...
                     <asp:TextBox ID="confirmpassword" required="true" type="password" name="c_np" placeholder="Confirm New Password" CssClass="form-control" BorderColor="#CCCCCC" runat="server" Height="36px"></asp:TextBox>

                    </div>
                    <div class="form-group">
                        
                         <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Password donot match" ControlToCompare="newpassword" ControlToValidate="confirmpassword" Font-Size="Small" ForeColor="#FF3300"></asp:CompareValidator>
