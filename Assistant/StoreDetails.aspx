<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="StoreDetails.aspx.cs" Inherits="MasterPageDemo.User.StockDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <p>
        <h2 class="ml-0"> Sort The DVDS Which Are Currently Not Available</h2>
    ...
    <p>
     ...
     <h3 class="ml-0"> List of items in the Store where no item has been sold in the last 31 days. </h3>
    <p class="ml-5"> 
